  ...
  return (
    <div className="">
      <div className="relative flex justify-center items-center ">
        <img
          className="w-full h-screen object-cover md:object-left opacity-10"
          src={bounty}
          alt="bounty "
        />
      </div>
      <div className="absolute  m-auto flex  flex-col inset-0 w-[50%]  p-4 z-1  h-[39rem] mb-5  border border-n-1/10 rounded-3xl  xl:h-[46rem]">
