...
const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 w-full z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 ${
    ...
    >
      <div className="flex  items-center py-5 px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        >
          <div className="relative z-2 flex gap-8 flex-col items-center justify-center m-auto lg:flex-row">
            {navigation.map((item) => (
              <a
