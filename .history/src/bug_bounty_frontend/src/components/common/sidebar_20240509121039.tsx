...
const Sidebar = () => {
  ...
  return (
    <aside
      className={` hidden  lg:w-60 -translate-x-70 lg:top-16 lg:h-[calc(100vh-theme(space.16))] lg:flex flex-col  ${
        open ? "w-72" : "w-[4.5rem]"
      } lg:-translate-x-0 left-0 bg-background-default border-r  transition-[width,transform] duration-300 ease-in-out group fixed top-0  h-full `}
    >
