          ...
          <div key={i} className="group">
            ...
            >
              ...
              <h3
                ...
                className={` ${
                  open && "hidden "
                } absolute left-[18rem] bg-linear-3 font-semibold whitespace-pre text-[#ffffff], rounded-md drop-shadow-lg px-0 py-0 w-0 overflow-hidden group-hover:px-2 group-hover:py-1 group-hover:left-[3.8rem] group-hover:duration-300 group-hover:w-fit `}
              >
                {menu.name}
              </h3>
              {menu.subMenu && (
