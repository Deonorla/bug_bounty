  ...
  return (
    <aside
      className={` hidden lg:top-16 lg:h-[calc(100vh-theme(space.16))] lg:flex flex-col  ${
        open ? "w-60" : "w-[4.5rem]"
      } left-0 border-y-[transparent] border-l-[transparent]  border-r-white/10 border border-solid transition-[width,transform] duration-300 ease-in-out group fixed top-0 h-full `}
    >
